...
namespace TelegramInterface.BaseTypes.Requests.Inline
{
    /// <summary>
    ...
    public class AnswerInlineQuery
    {
        ...
        /// <summary>
        /// Optional
        /// If passed, clients will display a button with specified text that switches the user to a private chat with the bot and sends
        ...
        /// <summary>
        /// Optional
        /// Deep-linking parameter for the /start message sent to the bot when user presses the switch button. 1-64 characters,
        ...
        /// any. The user presses the button, switches to a private chat with the bot and, in doing so, passes a start parameter that
        /// instructs the bot to return an oauth link. Once done, the bot can offer a switch_inline button so that the user can easily
